        ...
        <section id="hero" className="py-20 md:py-28 flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Button variant="outline" asChild>
                <a href="https://drive.google.com/file/d/13hF2Mqg4NIvu_LcA3XhanVEaiYuhmUL1/view?usp=sharing" target="_blank">My Resume</a>
              </Button>
            </div>
        ...
        <section id="experience" className="py-16 scroll-mt-16">
          ...
          <Card className="border-none shadow-none">
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  <CardTitle>Software Developer - <strong>IMPACT BBDO</strong></CardTitle>
                  <CardDescription>Dubai, United Arab Emirates (On-site)</CardDescription>
                </div>
                <div className="flex flex-col items-end">
                  <Badge>Apr 2026 - Present</Badge>
          ...
          <Card className="border-none shadow-none">
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  <CardTitle>Software Engineer - <strong>DuoFankaar</strong></CardTitle>
                  <CardDescription>Dubai, United Arab Emirates (Hybrid)</CardDescription>
                </div>
                <div className="flex flex-col items-end">
                  <Badge>April 2025 - Mar 2026</Badge>
          ...
          <Card className="border-none shadow-none">
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  <CardTitle>RPA Developer - <strong>SYBROS TECH</strong></CardTitle>
        ...
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <Button variant="outline" size="sm" asChild>
              <a href="https://drive.google.com/file/d/13hF2Mqg4NIvu_LcA3XhanVEaiYuhmUL1/view?usp=sharing" download>
