        ...
        <section id="hero" className="py-20 md:py-28 flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Button variant="outline" asChild>
                <a href="https://drive.google.com/file/d/1b93m3aXePUzkG8T1qQMWmGPeDTx2NbW0/view?usp=sharing" target="_blank">My Resume</a>
              </Button>
            </div>
        ...
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <Button variant="outline" size="sm" asChild>
              <a href="https://drive.google.com/file/d/1b93m3aXePUzkG8T1qQMWmGPeDTx2NbW0/view?usp=sharing" download>
